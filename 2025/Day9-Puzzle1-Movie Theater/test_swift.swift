...
let inputPath = "Inputs/test_new.txt"
...
print("Read \(redTiles.count) red tiles")
...
print("\nPart 1: \(maxArea1)")
print("  Corners: (\(redTiles[maxI1].x),\(redTiles[maxI1].y)) to (\(redTiles[maxJ1].x),\(redTiles[maxJ1].y))")

print("\nPart 2: \(maxArea2)")
print("  Corners: (\(redTiles[maxI2].x),\(redTiles[maxI2].y)) to (\(redTiles[maxJ2].x),\(redTiles[maxJ2].y))")
